...
document.getElementById('downloadResume').addEventListener('click', function(e) {
    ...
    link.download = 'Dharani_Dharan_Resume.pdf';
...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.project-card, .skill-category, .stat-item, .education-content');
...
window.addEventListener('load', () => {
    ...
    if (nameElement) {
        setTimeout(() => {
            typeWriter(nameElement, 'Anne Isabel W', 150);
        }, 500);
    }
});
...
console.log('%c🚀 Welcome to Anne Isabel W\'s Portfolio!', 'color: #2563eb; font-size: 20px; font-weight: bold;');
